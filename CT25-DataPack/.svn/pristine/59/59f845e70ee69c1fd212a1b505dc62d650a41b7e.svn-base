...
REM ##################################################
REM Copyright (C) 2010 BR Xtreme DataPack
...
REM 675 Mass Ave, Cambridge, MA 02139, USA. Or contact the Official BR Xtreme l2j
REM DataPack Project at http://brxtreme.forumxpress.org, http://brxtreme.forumxpress.org or
...
set cmdline=
if %full% == 1 (
title BR Xtreme DP Installer - Login Server DataBase Setup - Installing...
echo.
echo Installing new Login Server content.
echo.
) else (
title BR Xtreme DP Installer - Login Server DataBase Setup - Upgrading...
echo.
...
set cmdline=
set stage=4
title BR Xtreme DP Installer - Community Server DataBase Setup
echo.
...
:cb_err1
call :colors 47
title BR Xtreme DP Installer - Community Server DataBase Setup ERROR!
cls
echo.
echo Backup attempt failed! A possible reason for this to 
echo happen, is that your DB doesn't exist yet. I could 
...
set cmdline=
set stage=5
title BR Xtreme DP Installer - Communty Server DataBase Setup - DB Creation
echo.
...
:cs_db_ok
call :colors 17
title BR Xtreme DP Installer - Community Server DataBase Setup - WARNING!
:cs_ask
cls
...
call :colors 17
set cmdline=
title BR Xtreme DP Installer - Community Server DataBase Setup - Full Install
echo.
...
set cmdline=
if %full% == 1 (
title BR Xtreme DP Installer - Community Server DataBase Setup - Installing...
echo.
echo Installing new Community Server content.
echo.
) else (
title BR Xtreme DP Installer - Community Server DataBase Setup - Upgrading...
echo.
...
:gs_err1
call :colors 47
title BR Xtreme DP Installer - Game Server DataBase Setup - Backup ERROR!
cls
echo.
...
:gs_err2
call :colors 47
title BR Xtreme DP Installer - Game Server DataBase Setup - DB Creation ERROR!
cls
echo.
echo An error occured while trying to create a database for 
...
title BR Xtreme DP Installer - Custom Server Tables Process Complete
cls
echo Database structure for BR Xtreme Custom finished.
echo.
...
echo (aka Xtreme mods) to get enabled with a minimum of changes.
echo.
...
title BR Xtreme DP Installer - Mod Server Tables Process Complete
cls
...
echo.
echo 1-Read the BR Xtreme Datapack project forum :
echo       (http://brxtreme.forumxpress.org)
...
cls
echo.
echo BR Xtreme DP Database Installer 2013
echo.
echo (C) 2010-2013 BR Xtreme DataPack Team
