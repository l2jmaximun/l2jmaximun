...
{
	protected static final Logger _log = Logger.getLogger(UndergroundColiseumManager.class.getName());

	private TIntObjectHashMap<UCArena> _arenas = new TIntObjectHashMap<UCArena>(5);
	...
	private UndergroundColiseumManager()
	{
		load();	
