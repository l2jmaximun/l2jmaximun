 ...
 */
package ct25.xtreme.gameserver.model.variables;

import java.util.concurrent.atomic.AtomicBoolean;

import javolution.util.FastMap;

import ct25.xtreme.gameserver.model.interfaces.IRestorable;
import ct25.xtreme.gameserver.model.interfaces.IStorable;
