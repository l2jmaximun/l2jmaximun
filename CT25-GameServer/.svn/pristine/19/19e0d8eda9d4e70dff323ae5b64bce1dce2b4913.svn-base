...
import ct25.xtreme.gameserver.model.actor.status.FolkStatus;
...
import ct25.xtreme.gameserver.skills.effects.EffectBuff;
import ct25.xtreme.gameserver.skills.effects.EffectDebuff;
