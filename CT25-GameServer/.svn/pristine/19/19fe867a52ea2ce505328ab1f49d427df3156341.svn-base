...
import ct25.xtreme.gameserver.model.entity.DimensionalRift;
...
import ct25.xtreme.gameserver.network.serverpackets.ExAskModifyPartyLooting;
import ct25.xtreme.gameserver.network.serverpackets.ExCloseMPCC;
import ct25.xtreme.gameserver.network.serverpackets.ExOpenMPCC;
...
import ct25.xtreme.gameserver.network.serverpackets.ExSetPartyLooting;
import ct25.xtreme.gameserver.network.serverpackets.L2GameServerPacket;
import ct25.xtreme.gameserver.network.serverpackets.PartyMemberPosition;
import ct25.xtreme.gameserver.network.serverpackets.PartySmallWindowAdd;
import ct25.xtreme.gameserver.network.serverpackets.PartySmallWindowAll;
import ct25.xtreme.gameserver.network.serverpackets.PartySmallWindowDelete;
...
public class L2Party extends AbstractPlayerGroup
{
	 ...
	 * @see ct25.xtreme.gameserver.model.actor.instance.L2PcInstance#isRequestExpired()
	 */
