...
import ct25.xtreme.gameserver.network.serverpackets.ExDuelEnd;
import ct25.xtreme.gameserver.network.serverpackets.ExDuelReady;
import ct25.xtreme.gameserver.network.serverpackets.ExDuelStart;
