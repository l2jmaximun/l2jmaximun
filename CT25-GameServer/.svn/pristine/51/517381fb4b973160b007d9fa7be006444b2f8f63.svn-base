 ...
 * <p>A SessionKey is made up of two 8 bytes keys. One is send in the {@link ct25.xtreme.loginserver.serverpacket.LoginOk LoginOk}
 * packet and the other is sent in {@link ct25.xtreme.loginserver.serverpacket.PlayOk PlayOk}</p>
 * @author -Wooden-
 *
 */
