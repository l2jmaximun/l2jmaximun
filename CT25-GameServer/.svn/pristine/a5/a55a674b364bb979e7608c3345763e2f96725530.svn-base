...
import ct25.xtreme.gameserver.model.actor.knownlist.AttackableKnownList;
import ct25.xtreme.gameserver.model.actor.status.AttackableStatus;
...
public class L2Attackable extends L2Npc
{
	...
	/**
	 * 
	 * @see ct25.xtreme.gameserver.model.actor.L2Character#addAttackerToAttackByList(ct25.xtreme.gameserver.model.actor.L2Character)
	 */
	@Override
