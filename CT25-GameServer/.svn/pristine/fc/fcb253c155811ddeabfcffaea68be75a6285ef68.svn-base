package ct25.xtreme.gsregistering;
...
import ct25.xtreme.loginserver.GameServerTable;
...
public class GUserInterface extends BaseGameServerRegister implements ActionListener
{
	...
	/**
	 * @see ct25.xtreme.gsregistering.BaseGameServerRegister#showError(java.lang.String, java.lang.String, java.lang.Throwable)
	 */
	@Override
