...
import ct25.xtreme.util.PrimeFinder;
...
public class BitSetIDFactory extends IdFactory
{
	...
	/**
	 * 
	 * @see ct25.xtreme.gameserver.idfactory.IdFactory#releaseId(int)
	 */
	@Override
	...
	/**
	 * 
	 * @see ct25.xtreme.gameserver.idfactory.IdFactory#getNextId()
	 */
	@Override
	...
	/**
	 * 
	 * @see ct25.xtreme.gameserver.idfactory.IdFactory#size()
	 */
	@Override
