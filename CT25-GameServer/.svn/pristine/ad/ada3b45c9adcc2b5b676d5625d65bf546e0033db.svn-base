...
import ct25.xtreme.gameserver.network.serverpackets.ExCursedWeaponLocation;
import ct25.xtreme.gameserver.network.serverpackets.ExCursedWeaponLocation.CursedWeaponInfo;
