...
import ct25.xtreme.gameserver.ai.L2AirShipAI;
...
import ct25.xtreme.gameserver.network.serverpackets.ExAirShipInfo;
import ct25.xtreme.gameserver.network.serverpackets.ExGetOffAirShip;
import ct25.xtreme.gameserver.network.serverpackets.ExGetOnAirShip;
import ct25.xtreme.gameserver.network.serverpackets.ExMoveToLocationAirShip;
import ct25.xtreme.gameserver.network.serverpackets.ExStopMoveAirShip;
