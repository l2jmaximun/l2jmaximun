 ...
 */
package ct25.xtreme.gameserver.taskmanager;

import static ct25.xtreme.gameserver.taskmanager.TaskTypes.TYPE_NONE;
import static ct25.xtreme.gameserver.taskmanager.TaskTypes.TYPE_SHEDULED;
import static ct25.xtreme.gameserver.taskmanager.TaskTypes.TYPE_TIME;
...
import ct25.xtreme.gameserver.taskmanager.tasks.TaskRaidPointsReset;
import ct25.xtreme.gameserver.taskmanager.tasks.TaskRecom;
import ct25.xtreme.gameserver.taskmanager.tasks.TaskRestart;
import ct25.xtreme.gameserver.taskmanager.tasks.TaskScript;
import ct25.xtreme.gameserver.taskmanager.tasks.TaskSevenSignsUpdate;
import ct25.xtreme.gameserver.taskmanager.tasks.TaskShutdown;
