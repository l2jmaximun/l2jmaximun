...
import ct25.xtreme.loginserver.serverpackets.GGAuth;
...
public class AuthGameGuard extends L2LoginClientPacket
{
	...
	/**
	 * @see ct25.xtreme.loginserver.clientpackets.L2LoginClientPacket#readImpl()
	 */
	@Override
	...
	/**
	 * @see ct25.xtreme.mmocore.network.ReceivablePacket#run()
	 */
	@Override
	public void run()
	{
