...
public abstract class L2PlayableAI extends L2CharacterAI
{
	...
	/**
	 * @see ct25.xtreme.gameserver.ai.L2CharacterAI#onIntentionAttack(ct25.xtreme.gameserver.model.actor.L2Character)
	 */
	@Override
	...
	/**
	 * @see ct25.xtreme.gameserver.ai.L2CharacterAI#onIntentionCast(ct25.xtreme.gameserver.model.L2Skill, ct25.xtreme.gameserver.model.L2Object)
	 */
	@Override
