...
import ct25.xtreme.gameserver.model.zone.type.L2DerbyTrackZone;
import ct25.xtreme.gameserver.model.zone.type.L2PeaceZone;
			...
			//synchronized (_visibleObjects)
			{
				for(L2Object o: vObj)
				{
					if (o instanceof L2Attackable)
					{
						...
						if (mob.hasAI())
						{
							mob.getAI().setIntention(ct25.xtreme.gameserver.ai.CtrlIntention.AI_INTENTION_IDLE);
