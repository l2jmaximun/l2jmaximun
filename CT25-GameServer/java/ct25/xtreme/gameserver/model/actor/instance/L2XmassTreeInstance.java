...
public class L2XmassTreeInstance extends L2Npc
{
	...
	/* (non-Javadoc)
	 * @see ct25.xtreme.gameserver.model.L2Object#isAttackable()
	 */
	@Override
	...
	/**
	 * @see ct25.xtreme.gameserver.model.actor.L2Npc#onAction(ct25.xtreme.gameserver.model.actor.instance.L2PcInstance, boolean)
	 */
	@Override
