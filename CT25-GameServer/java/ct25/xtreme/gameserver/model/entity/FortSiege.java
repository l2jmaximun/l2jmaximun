...
import ct25.xtreme.gameserver.instancemanager.FortSiegeGuardManager;
import ct25.xtreme.gameserver.instancemanager.FortSiegeManager;
import ct25.xtreme.gameserver.instancemanager.FortSiegeManager.SiegeSpawn;
import ct25.xtreme.gameserver.model.CombatFlag;
...
public class FortSiege implements Siegable
{
	...
	/* (non-Javadoc)
	 * @see ct25.xtreme.gameserver.model.entity.Siegable#giveFame()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ct25.xtreme.gameserver.model.entity.Siegable#getFameFrequency()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ct25.xtreme.gameserver.model.entity.Siegable#getFameAmount()
	 */
	@Override
