...
import ct25.xtreme.gameserver.model.zone.form.ZoneCuboid;
import ct25.xtreme.gameserver.model.zone.form.ZoneCylinder;
import ct25.xtreme.gameserver.model.zone.form.ZoneNPoly;
import ct25.xtreme.gameserver.model.zone.type.L2ArenaZone;
import ct25.xtreme.gameserver.model.zone.type.L2OlympiadStadiumZone;
					...
					if ("list".equalsIgnoreCase(n.getNodeName()))
					{
						...
						for (Node d = n.getFirstChild(); d != null; d = d.getNextSibling())
						{
							if ("zone".equalsIgnoreCase(d.getNodeName()))
							{
								...
								try
								{
									newZone = Class.forName("ct25.xtreme.gameserver.model.zone.type.L2" + zoneType);
								}
